...
export default function Productos() {
  ...
  const { orderFilterState, setOrderFilterState, handleActiveOrder } =
    useCategory();
    ...
    <ProductsLayout>
      <>
        ...
        <div className="w-full h-auto flex justify-between items-center mb-10">
          ...
          >
            <p className="mr-2 text-white text-sm font-medium tracking-wider">
              FILTRAR
            </p>
            <FontAwesomeIcon
        ...
        <ul className="w-full h-full flex justify-around flex-wrap py-8">
          {products.map((product) => (
            <li
              className="relative w-[150px] h-[280px] rounded-md mb-8 flex flex-col justify-evenly items-center"
              key={product.id}
            >
