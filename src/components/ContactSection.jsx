                ...
                <div className="w-full h-auto flex flex-row p-4">
                    <div className="w-full h-auto flex flex-col">
                        ...
                        <ul className="w-full h-auto flex flex-col items-start justify-center">
                            ...
                            <li className="text-white text-sm mb-4 font-medium">PRODUCTOS DESTACADOS</li>
                            <li className="text-white text-sm mb-4 font-medium">CATEGORIAS</li>
                        </ul>
                    </div>
                    <div className="w-full h-auto flex flex-col ">
                        <p className="text-base text-white mb-4 font-bold text-right">MÁS INFORMACIÓN</p>
                        <ul className="w-full h-auto flex flex-col items-end justify-center">
                            <li className="text-white text-sm mb-4 font-medium">COMO COMPRAR</li>
                            <li className="text-white text-sm mb-4 font-medium">OFERTAS</li>
                            <li className="text-white text-sm mb-4 font-medium">SOBRE NOSOTROS</li>
                            <li className="text-white text-sm mb-4 font-medium text-right">CONTACTO</li>
                        </ul>
                    </div>
                </div>
                <div className="w-full h-auto p-4">
                    ...
                    <div className="w-full h-auto flex">
                        <div className="w-auto h-auto bg-gray-700 p-2 mr-2 rounded-full">
                            <FontAwesomeIcon className="w-[26px] h-[26px] text-white" icon={faWhatsapp} />
                        </div>
                        <div className="w-auto h-auto bg-gray-700 p-2 rounded-full">
                            <FontAwesomeIcon className="w-[26px] h-[26px] text-white" icon={faInstagram} />
                        </div>
                        <div></div>
                    </div>
                </div>
