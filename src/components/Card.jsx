...
<div ref={element} className="relative w-[250px] h-[400px] p-4 mr-8 rounded-md flex flex-col justify-around items-center">
            {
                screen ?
                    <div className="animate-subtitleAppear w-full pb-4 h-full shadow-lg bg-white rounded-md flex flex-col justify-between items-center relative">
