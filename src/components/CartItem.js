        ...
        <li className="w-full h-[auto] min-h-[100px] flex flex-col justify-between p-2 mb-4 border-b border-gray-200">
            ...
            <div className="w-full px-2 h-full flex flex-col justify-around relative">
                <div>
                    ...
                    <p className="text-black font-medium flex w-full justify-between items-center">{itemOffer == "2x1" ? "" : "Descuento:"} <b>{itemOffer != "2x1" ? `- $${discountPrice * itemQuantity}` : <></>}</b></p>
                    <p className="text-black font-medium flex w-full justify-between items-center">Total: <b>{itemOffer != "2x1" ? `$${discountTotal * itemQuantity}` : `$${itemQuantity * itemPrice}`}</b></p>
                </div>
            </div>
        </li>
    )
