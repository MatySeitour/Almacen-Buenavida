            ...
            <div className="w-full h-auto flex flex-row p-4 mb-4 shadow-md rounded-md bg-white relative">
                <div className="w-full h-auto flex flex-row">
                    ...
                    <div className="w-auto h-auto flex flex-col items-start justify-center mb-2 pl-2">
                        <h5 className="text-base max-w-[180px] text-green-500 font-medium mb-2">{itemName.length > 30 ? `${itemName.slice(0, 30)}...` : itemName}</h5>
                ...
                <div className="w-auto h-auto flex justify-center items-center">
                    <div className="w-[auto] h-[auto] flex flex-row rounded-md justify-between items-center">
                        <button
                            ...
                            className="w-[20px] h-[20px] bg-green-500 ont-bold text-base text-white rounded-sm flex justify-center items-center" type="text">-</button>
                        <p className="text-lg text-green-500 w-[20px] h-[20px] flex justify-center items-center text-center bg-transparent outline-none ml-1 mr-1">{itemQuantity}</p>
                        <button
                            onClick={() => {
                                const newCartItem = {
                                    name: itemName,
                            ...
                            className="w-[20px] h-[20px] bg-green-500 font-bold text-base text-white rounded-sm flex justify-center items-center" type="text">+</button>
                    </div>
                </div>
            </div>
