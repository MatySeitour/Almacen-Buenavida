      ...
      >
        <div className="fixed top-0 w-full h-auto min-h-[60px] flex justify-between items-center z-[10000000] px-4">
          <div
            ...
            className="w-[40px] h-[40px] shadow-md rounded-md flex justify-center items-center bg-white"
          >
            <FontAwesomeIcon
          ...
          <div className="w-[70%] p-2 text-center">
            <h4 className="text-green-500 text-base tracking-wide font-medium">
              CARRITO DE COMPRAS
            </h4>
          </div>
          <div></div>
        ...
        {cartItems.length !== 0 ? (
          <div className="w-full h-full flex flex-col justify-between items-center">
            ...
            <div className="w-full h-auto flex shadow-default py-4 px-2">
              ...
              <div className="w-full h-auto flex flex-col justify-center items-center">
                <button
                  className=" p-2 w-[90%] bg-green-500 rounded-md text-white tracking-wide font-medium text-base"
                  type="text"
                >
                  COMPRAR
                </button>
          ...
          <div className="w-full h-full flex flex-col items-center justify-center p-2">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-[100px] h-[100px] text-green-500"
            >
              <path
                strokeLinecap="round"
